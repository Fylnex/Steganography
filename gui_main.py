...
class SteganographyApp:
    ...
    def perform_embedding(self):
        ...
        if self.image_path and self.data_file_path and self.password_entry.get():
            try:
                ...
                # Встраивание данных в изображение с паролем
                password = self.password_entry.get()
                modified_image = embedder.embed_data(image, data, password)
            ...
            messagebox.showerror("Error", "Please select image, data file and enter a password.")
    ...
    def perform_extraction(self):
        ...
        if self.image_path and self.password_entry.get():
            try:
                ...
                # Извлечение данных из изображения с проверкой пароля
                password = self.password_entry.get()
                extracted_data = extractor.extract_data(image, password)
            ...
            messagebox.showerror("Error", "Please select image and enter a password.")
